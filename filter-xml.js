    ...
    const programasFiltrados = resultIconos.tv.programme
      ...
      .filter(p => 
        [
          ...
          'GOL PLAY', 'Eurosport 1 HD', 'Eurosport 2', 'FIFA+', 'Real Madrid TV', 'Top Barça', 'Esport 3', 'LALIGA Inside', 
          ...
          'TV3', 'TV3 Catalunya', 'El 33 Catalunya', '324', 'SX3', 'Canal Extremadura', 'Canal Extremadura SAT', 'TVG Europa HD', 
