    ...
    const programasFiltrados = resultIconos.tv.programme
      ...
      .filter(p => 
        [
          ...
          'À Punt', 'CMM TV', 'La 7 CyL', 'TV3', '324', 'SX3', 'Canal Extremadura', 'Canal Extremadura SAT', 'TVG Europa HD', 'IB3 TV Illes Balears', 
          'TV Canaria', 'Telemadrid', 'Telemadrid Internacional', 'La Otra', 'La 7 Murcia', 'Navarra TV', 'ETB1', 'ETB2', 'EITB Basque', 
          'Decasa', 'Canal Cocina', 'Vivir con perros', 'Vivir con gatos', 'Flamenco Auditorio', '24 Horas', 'EuroNews', 'Negocios TV', 
          'CNN en Español', 'Clan', 'Boing', 'Anime Visión', 'Anime Visión Classics', 'Disney Junior'
        ].includes(p.$.channel));
