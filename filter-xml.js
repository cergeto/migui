    ...
    const programasFiltrados = resultIconos.tv.programme
      ...
      .filter(p => 
        [
          ...
          'DKISS', 'Ten', 'AMC Break', 'Discovery', 'Canal Hollywood HD', 'Atrescine', 'Somos', 'AMC HD', 'TCM HD', 
          ...
          'Películas Románticas (Rakuten TV)', 'Cine Español (Rakuten TV)', 'Thrillers (Rakuten TV)', 'En Familia (Rakuten TV)', 'Veo7', 'Comedy Central HD',  
          'Energy', 'Divinity', 'Neox', 'Atreseries', 'Factoría de Ficción', 'Nova', 'Cosmo HD', 'STAR Channel HD', 'Warner TV HD', 'VinTV', 
          'Calle 13 HD', 'AXN HD', 'SyFy HD', 'BBC Series', 'Historia', 'Odisea', 'AMC Crime', 'Sangre Fría', 'National Geographic HD', 'Nat Geo Wild HD', 
